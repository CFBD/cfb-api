    ...
    const getPlays = async (id) => {
        ...
        for (let drive of driveData) {
            ...
            let d = {
                ...
                endPeriod: drive.end.period.number,
                endClock: drive.end.clock ? drive.end.clock.displayValue : null,
                endYardsToGoal: offense.homeAway == 'home' ? 100 - drive.end.yardLine : drive.end.yardLine,
