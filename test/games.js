...
describe('Games', () => {
    ...
    describe('Weather', () => {
        it('Should retrieve game weather for the given year', async () => {
            const data = await service.getWeather(2020);
        ...
        it('Should retrieve game weather for the given year and week', async () => {
            const data = await service.getWeather(2020, null, 5);
        ...
        it('Should retrieve game weather for the given year and team', async () => {
            const data = await service.getWeather(2020, null, null, 'UCLA');
        ...
        it('Should retrieve game weather for the given year and conference', async () => {
            const data = await service.getWeather(2020, null, null, null, 'ACC');
